...
- **The body** is the procedure, not an essay: a section per slot and no slot
  empty — how to run it; what it produces; a closing "what it is not" that
  fences it off from the neighbouring skill it will otherwise be confused with.
